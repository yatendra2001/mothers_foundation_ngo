...
const kPrimaryVioletColor = Color.fromARGB(255, 116, 29, 127);
const kPrimaryWhiteColor = Color.fromARGB(255, 255, 255, 255);
const kPrimaryRedColor = Color.fromARGB(255, 182, 32, 32);
const kPrimaryBlackColor = Color(0xff4D7033);
...
const kAppbarColor = Color(0xff2C2C2C);
